...
import apiKeys from "../data/email"
...
function Contact() {
    ...
    const submitHandler = (event) => {
        ...
        if (!formdata.name) {
            ...
            setError(false);
            emailjs.sendForm(apiKeys.SERVICE_ID, apiKeys.TEMPLATE_ID, event.target, apiKeys.USER_ID).then(result => {
                    setMessage('You message has been sent!!! Will get back to you shortly');
                },
                error => {
                            ...
                            <div className="mi-contact-formwrapper">
                                ...
                                <form action="#" className="mi-form mi-contact-form" onSubmit={submitHandler}>
                                    ...
                                    <div className="mi-form-field">
                                        ...
                                        <input onChange={handleChange} type="text" name="subject"
                                               id="contact-form-subject"
                                               value={formdata.subject}/>
                                    </div>
                                    <div className="mi-form-field">
                                        <label htmlFor="contact-form-message">Enter your Message*</label>
                                        <textarea onChange={handleChange} name="message" id="contact-form-message"
                                                  cols="30"
                                                  rows="6" value={formdata.message}></textarea>
                                    </div>
                                    <div className="mi-form-field">
                      ...
                      <Icon.Phone/>
                                        ...
                                        <div className="mi-contact-infoblock-content">
                                            ...
                                            {phoneNumbers.map(phoneNumber => (
                                                <p key={phoneNumber}><a
                                                    href={numberFormatter(phoneNumber)}>{phoneNumber}</a></p>
                                            ))}
                                        </div>
                                    </div>
                                )}
